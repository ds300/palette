...
const FONT_SIZE_RATIO = 1.142
const SANS_LINE_HEIGHT_RATIO = 1.17
...
export const themeProps = {
  ...
  typeSizes: {
    ...
    sans: {
      ...
      "0": {
        fontSize: 8 * FONT_SIZE_RATIO,
        lineHeight: 8 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 10px size / 14px line-height  */
      "1": {
        fontSize: 10 * FONT_SIZE_RATIO,
        lineHeight: 14 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 12px size / 16px line-height  */
      "2": {
        fontSize: 12 * FONT_SIZE_RATIO,
        lineHeight: 16 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 14px size / 24px line-height  */
      "3": {
        fontSize: 14 * FONT_SIZE_RATIO,
        lineHeight: 24 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 14px size / 20px line-height  */
      "3t": {
        fontSize: 14 * FONT_SIZE_RATIO,
        lineHeight: 20 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 16px size / 26px line-height  */
      "4": {
        fontSize: 16 * FONT_SIZE_RATIO,
        lineHeight: 26 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 16px size / 22px line-height  */
      "4t": {
        fontSize: 16 * FONT_SIZE_RATIO,
        lineHeight: 22 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 18px size / 30px line-height  */
      "5": {
        fontSize: 18 * FONT_SIZE_RATIO,
        lineHeight: 30 * SANS_LINE_HEIGHT_RATIO,
      },
      ...
      "6": {
        fontSize: 22 * FONT_SIZE_RATIO,
        lineHeight: 30 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 28px size / 36px line-height  */
      "8": {
        fontSize: 28 * FONT_SIZE_RATIO,
        lineHeight: 36 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 42px size / 50px line-height  */
      "10": {
        fontSize: 42 * FONT_SIZE_RATIO,
        lineHeight: 50 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 60px size / 66px line-height  */
      "12": {
        fontSize: 60 * FONT_SIZE_RATIO,
        lineHeight: 66 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 80px size / 84px line-height  */
      "14": {
        fontSize: 80 * FONT_SIZE_RATIO,
        lineHeight: 84 * SANS_LINE_HEIGHT_RATIO,
      },
      /** Equivalent to 100px size / 104px line-height  */
      "16": {
        fontSize: 100 * FONT_SIZE_RATIO,
        lineHeight: 104 * SANS_LINE_HEIGHT_RATIO,
      },
    },
    ...
    serif: {
      ...
      "6": {
        fontSize: 26 * FONT_SIZE_RATIO,
        lineHeight: 32,
      },
      /** Equivalent to 32px size / 38px line-height  */
      "8": {
        fontSize: 32 * FONT_SIZE_RATIO,
        lineHeight: 38,
      },
      /** Equivalent to 44px size / 50px line-height  */
      "10": {
        fontSize: 44 * FONT_SIZE_RATIO,
        lineHeight: 50,
      },
